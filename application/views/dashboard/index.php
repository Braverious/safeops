...
<div class="container-fluid">
    ...
    <div class="card mb-4 border border-dark" style="box-shadow: -5px 5px 5px 0px rgba(143,143,143,0.73);">
        ...
        <div class="text-overlay">
            <h1 class="h3 mb-4 text-white" style="text-shadow: 2px 2px #2B1C2F;">
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            <div class="card border border-dark"
                ...
                <i class="fas fa-solid fa-sack-dollar"
    ...
    <div class="col-lg-6">
        <div class="card border border-dark" style="box-shadow: -5px 5px 5px 0px rgba(143,143,143,0.73);">
            ...
            <div class="card-body" style="padding-bottom: 1px;">
                <ul>
                    <li><a href="<?= base_url('reports/wajib') ?>">Laporan Wajib</a></li>
                    <li><a href="<?= base_url('reports/rutin') ?>">Laporan Rutin</a></li>
